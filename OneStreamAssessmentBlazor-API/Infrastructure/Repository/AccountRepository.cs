...
namespace Infrastructure.Repository
{
       ...
       SignInManager<ApplicationUser> signInManager, AppDbContext context) : IAccount
    {
        ...
        private async Task<Response> AssignUserToRole(ApplicationUser user, IdentityRole role)
        {
            ...
            return new Response(true, $"{user.Name} successfully assigned to the {role.Name} role.");
        }
        ...
        public async Task<Response> ChangeUserRoleAsync(ChangeUserRoleRequestDTO model)
        {
            ...
            if (role == null) return new Response(false, "Role not found");
            ...
            return new Response(true, "Role changed successfully.");
        }
        ...
        public async Task<Response> CreateRoleAsync(CreateRoleDTO model)
        {
            try
            {
                ...
                return new Response(true, $"{model.Name} role successfully created.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<LoginResponse> LoginAccountAsync(LoginDTO model)
        {
            try
            {
                ...
                {
                    return new LoginResponse(false, "Failed to save refresh token, please try again.");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<LoginResponse> RefreshTokenAsync(RefreshTokenDTO model)
        {
            try
            {
                ...
                {
                    return new LoginResponse(false, "Failed to save new refresh token.");
                }
            }
            catch (Exception ex)
            {
