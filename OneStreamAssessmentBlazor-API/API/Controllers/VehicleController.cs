...
namespace API.Controllers
{
    ...
    public class VehicleController : ControllerBase
    {
        ...
        public async Task<ActionResult<GetVehicleResponseDTO>> Get(int id)
        {
            ...
            {
                return NotFound(); // Return NotFound if vehicle is not found
            }
        ...
        public async Task<ActionResult<GetVehicleBrandResponseDTO>> GetBrand(int id)
        {
            ...
            {
                return NotFound(); // Return NotFound if brand is not found
            }
        ...
        public async Task<ActionResult<GetVehicleOwnerResponseDTO>> GetOwner(int id)
        {
            ...
            {
                return NotFound(); // Return NotFound if owner is not found
            }
        ...
        public async Task<ActionResult<Response>> Delete(int id)
        {
            ...
            if (!response.Flag)
            {
                return NotFound(response.Message); // Return NotFound if the vehicle is not found
            }
            return Ok(response);
        }
