...
namespace Application.Service
{
    ...
    public class VehicleService(HttpClientService httpClientService) : IVehicleService
    {
        ...
        public async Task<Response> AddVehicle(CreateVehicleRequestDTO model)
        {
            ...
            return await result.Content.ReadFromJsonAsync<Response>() ?? ErrorOperation("Failed to add vehicle.");
        }
        ...
        public async Task<Response> AddVehicleBrand(CreateVehicleBrandRequestDTO model)
        {
            ...
            string? error = CheckResponseStatus(result);
            if (!string.IsNullOrEmpty(error)) return ErrorOperation(error);
            return await result.Content.ReadFromJsonAsync<Response>() ?? ErrorOperation("Failed to add vehicle brand.");
        }
        ...
        public async Task<Response> AddVehicleOwner(CreateVehicleOwnerRequestDTO model)
        {
            ...
            string? error = CheckResponseStatus(result);
            if (!string.IsNullOrEmpty(error)) return ErrorOperation(error);
            return await result.Content.ReadFromJsonAsync<Response>() ?? ErrorOperation("Failed to add vehicle owner.");
        }
        ...
        public async Task<Response> DeleteVehicle(int id)
        {
            ...
            string? error = CheckResponseStatus(result);
            if (!string.IsNullOrEmpty(error)) return ErrorOperation(error);
            return await result.Content.ReadFromJsonAsync<Response>() ?? ErrorOperation("Failed to delete vehicle.");
        }
        ...
        public async Task<Response> DeleteVehicleBrand(int id)
        {
            ...
            string? error = CheckResponseStatus(result);
            if (!string.IsNullOrEmpty(error)) return ErrorOperation(error);
            return await result.Content.ReadFromJsonAsync<Response>() ?? ErrorOperation("Failed to delete vehicle brand.");
        }
        ...
        public async Task<Response> DeleteVehicleOwner(int id)
        {
            ...
            string? error = CheckResponseStatus(result);
            if (!string.IsNullOrEmpty(error)) return ErrorOperation(error);
            return await result.Content.ReadFromJsonAsync<Response>() ?? ErrorOperation("Failed to delete vehicle owner.");
        }
        ...
        public async Task<Response> UpdateVehicle(UpdateVehicleRequestDTO model)
        {
            ...
            string? error = CheckResponseStatus(result);
            if (!string.IsNullOrEmpty(error)) return ErrorOperation(error);
            return await result.Content.ReadFromJsonAsync<Response>() ?? ErrorOperation("Failed to update vehicle.");
        }
        ...
        public async Task<Response> UpdateVehicleBrand(UpdateVehicleBrandRequestDTO model)
        {
            ...
            string? error = CheckResponseStatus(result);
            if (!string.IsNullOrEmpty(error)) return ErrorOperation(error);
            return await result.Content.ReadFromJsonAsync<Response>() ?? ErrorOperation("Failed to update vehicle brand.");
        }
        ...
        public async Task<Response> UpdateVehicleOwner(UpdateVehicleOwnerRequestDTO model)
        {
            ...
            string? error = CheckResponseStatus(result);
            if (!string.IsNullOrEmpty(error)) return ErrorOperation(error);
            return await result.Content.ReadFromJsonAsync<Response>() ?? ErrorOperation("Failed to update vehicle owner.");
        }
    }
}
